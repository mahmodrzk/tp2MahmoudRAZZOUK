...
@Named(value = "bean4") // Annotation indiquant que cet objet est géré par CDI (Contexts and Dependency Injection) avec le nom "bean2"
@RequestScoped // Portée de l'objet bean2 (RequestScoped signifie que l'objet est créé pour chaque requête)

public class Bean3 { // Classe Bean1 (nom de la classe peut être différent du nom de l'objet)
    ...
    public String afficher() { // Méthode pour rediriger vers une autre page
        return "affichage__4?nb=" + nombre + "&amp;faces-redirect=true"; // Retourne l'URL de redirection
    }
}
